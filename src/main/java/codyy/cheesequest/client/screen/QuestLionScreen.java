...
public class QuestLionScreen extends Screen {
    ...
    public static void renderEntity(PoseStack p_275613_, int p_275470_, int p_275319_, int p_275605_, Quaternionf p_275229_, @Nullable Quaternionf p_275230_, LivingEntity p_275237_) {
        PoseStack posestack = RenderSystem.getModelViewStack();
        posestack.pushPose();
        posestack.translate(0.0D, 0.0D, 1000.0D);
        RenderSystem.applyModelViewMatrix();
        p_275613_.pushPose();
        p_275613_.translate(p_275470_, p_275319_, -950.0D);
